  ...
  if (paso === 'completado') {
    ...
    return (
      <div className="fixed inset-0 bg-black/50 flex items-end sm:items-center justify-center z-50 p-0 sm:p-4 overflow-y-auto">
        <div className="bg-white rounded-t-2xl sm:rounded-lg shadow-lg max-w-2xl w-full flex flex-col max-h-[100dvh] sm:max-h-[90vh] my-auto">
          ...
          <div className="flex-shrink-0 border-t border-slate-200 p-4 space-y-3 bg-white rounded-b-lg pb-[max(1rem,env(safe-area-inset-bottom))]">
          {/* Botón de WhatsApp */}
          {WHATSAPP_VENTAS_ACTIVO && whatsappLink && (
            <div className="flex justify-center">
              <a
                ...
                className="w-full inline-flex items-center justify-center gap-2 px-6 py-3 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors font-medium"
              >
